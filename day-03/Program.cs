...
namespace day_03
{
  class Program
  {
    static void Main(string[] args)
    {
      ...
      //input = new string[] { "R8,U5,L5,D3", "U7,R6,D4,L4" };
      //input = new string [] { "R75,D30,R83,U83,L12,D49,R71,U7,L72", "U62,R66,U55,R34,D71,R55,D58,R83" };
      //input = new string[] { "R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51", "U98,R91,D20,R16,D67,R40,U7,R15,U6,R7" };
      ...
      for (var l=0;l<input.Length;l++)
      {
        ...
        int y = 0;
        var numSteps = 0;
        foreach (var step in input[l].Split(","))
        {
          var dir = step[0];
          ...
          for (var i=0;i<length;i++)
          {
            ...
            if (grid.TryGetValue(key, out var previous))
            {
              if (l == 1)
              {
                Console.WriteLine($"Found intersection at {key}");
                int sumSteps = previous + numSteps;
                if (sumSteps < closestIntersection) closestIntersection = sumSteps;
              }
            }
            else if (l == 0)
            {
              grid.Add(key, numSteps);
            }
          }
        }
      }
